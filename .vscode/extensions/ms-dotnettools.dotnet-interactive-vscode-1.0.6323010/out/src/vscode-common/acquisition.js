...
function acquireDotnetInteractive(args, requiredDotNetInteractiveVersion, globalStoragePath, getInteractiveVersion, createToolManifest, reportInstallationStarted, installInteractive, reportInstallationFinished) {
    var _a;
